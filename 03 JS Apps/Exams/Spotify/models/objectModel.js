const objectModel = function () {
    ...
    const createSong = function (params) {
        let data = {
    ...
    const getSong = function (id) {
        let url = `/appdata/${storage.appKey}/songs/${id}`;
        let headers = {
            headers: {}
        }
        return requester.get(url, headers)
    ...
    const likeSong = function (id, song) {
        let url = `/appdata/${storage.appKey}/songs/${id}`;
        let data = {
            ...song
        };
    ...
    const listenSong = function (id, song) {
        let url = `/appdata/${storage.appKey}/songs/${id}`;
        let data = {
            ...song
        };
